...
readonly OS_GO_PACKAGE=github.com/mrogers950/csr-approver-operator

readonly OS_BUILD_ENV_GOLANG="${OS_BUILD_ENV_GOLANG:-1.10.3}"
readonly OS_BUILD_ENV_IMAGE="${OS_BUILD_ENV_IMAGE:-openshift/origin-release:golang-${OS_BUILD_ENV_GOLANG}}"
readonly OS_REQUIRED_GO_VERSION="go1.10.3"
...
function os::build::images() {
  ...
  os::build::image "${tag_prefix}-csr-approver" .
}
